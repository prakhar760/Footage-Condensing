...
if not os.path.exists("ip_saved_media"):
    os.makedirs("ip_saved_media")
...
while True:
    ...
    if current_time - start_time >= capture_interval:
        ...
        if ret:
            ...
            filename = f"ip_saved_media/image_{current_time}.jpg"
    ...
    if len(image_frames) >= max_frames_per_video:
        ...
        video_filename = f"ip_saved_media/video_{current_time}.avi"
